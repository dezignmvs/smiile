...
const products: ProductType[] = [
    ...
    },
    {
        id: 2,
        section: "Category",
        link: ['Sujok','Mudra','EFT' ,'Smile Meditation']
    },
    {
        id: 3,
        section: "Events",
        link: ['Mannarkkad','Kozhikkode','Thrissur']
    },
    {
        id: 4,
        section: "Other Wesbites",
        link: ['Manifestation']
    }
]
            ...
            <div className="mx-auto max-w-2xl pt-8 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4'>
                        <h3 className='text-white text-4xl font-semibold leading-9 mb-4 lg:mb-20'> Smile Meditation Centre</h3>
            ...
            <div className="mx-auto max-w-2xl lg:max-w-7xl">
                <div className="pt-5 pb-5 px-4 sm:px-6 lg:px-4 border-solid border-t border-footer">
                    <div className="mt-4 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 xl:gap-x-8">
                        <div>
                            <h3 className='text-center md:text-start text-offwhite text-lg'>@2025 - All Rights Reserved by <Link href="https://adminmart.com/" target="_blank"> Mulaikhan.com</Link></h3>
                        </div>
