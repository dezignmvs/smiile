        ...
        <div className=" my-32">
            <div className='mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8'>
                ...
                <div className="text-center">
                    <h3 className="text-[#77530c] text-lg font-normal tracking-widest">JOIN US</h3>
                ...
                <div className="mx-auto max-w-4xl pt-5">
                    <div className="sm:flex items-center mx-5 p-5 sm:p-0 rounded-xl justify-between bg-lightgrey sm:rounded-full">
                        ...
                        <div className="sm:mr-3">
                            <button type="submit" className="joinButton w-full sm:w-0 text-xl text-white font-semibold text-center rounded-xl sm:rounded-full bg-[#3f4895] hover:bg-[#77530c]">
                                Join!
                            </button>
                        </div>
                    </div>
