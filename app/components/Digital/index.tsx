...
const Digital = () => {
    return (
        ...
        <div className="mx-2">
            <div className='mx-auto max-w-7xl px-4 my-40 pb-20 lg:pb-40 lg:px-8 bg-[#e5be46] rounded-3xl bg-blue relative'>
                <div className='grid grid-cols-1 lg:grid-cols-2 my-16'>
                    ...
                    <div className="pt-24 lg:pl-24 ">
                        ...
                        <div className="text-center lg:text-start">
                            <button className="text-xl font-semibold text-white bg-[#9b6d0c] py-4 px-12 hover:bg-[#c48c14] rounded-full">Get started</button>
                        </div>
                    </div>
