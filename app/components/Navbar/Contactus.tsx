        ...
        <>
            <div className=" inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto md:ml-6 sm:pr-0">
                ...
                <div className='hidden lg:block'>
                    <button type="button" className='justify-end text-xl font-semibold bg-transparent py-4 px-6 lg:px-12 navbutton rounded-full hover:bg-[#77530c] hover:text-white' onClick={openModal}>
                        Contact Us
                    </button>
                </div>
            </div>
                                    ...
                                    <div className="py-8 lg:py-8 px-4 mx-auto max-w-screen-md">
                                        ...
                                        <form action="#" className="space-y-8" onSubmit={handleSubmit}>
                                            ...
                                            <button type="submit"
                                                onClick={handleClick}
                                                disabled={isDisabled}
                                                className="py-3 px-5 text-sm disabled:opacity-50 font-medium w-full text-center text-white rounded-lg bg-[#3f4895] focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
