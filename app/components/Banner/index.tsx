            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 my-16'>
                ...
                <div className="mx-auto sm:mx-0">
                    <div className='py-3 text-center lg:text-start'>
                        <button className='text-[#77530c] bg-[#f3ebce] hover:shadow-xl text-sm md:text-lg font-bold px-6 py-1 rounded-3xl tracking-wider hover:text-white hover:bg-[#77530c]'>Smile Healing Center</button>
                    </div>
                    <div className="py-3 text-center lg:text-start">
                        <h1 className='text-6xl lg:text-80xl font-bold text-darkpurple'>
                            Join with Us.<br /> bring your <br /> ideas to life.
                        </h1>
                    </div>
