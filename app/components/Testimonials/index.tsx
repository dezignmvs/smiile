            ...
            <div className=" pt-40 pb-32 lg:py-32" id="testimonial-section">
                <div className='mx-auto max-w-7xl sm:py-4 lg:px-8 '>
                    ...
                    <div className="text-center">
                        <h3 className="text-4xl sm:text-6xl font-bold text-black my-3">Our Testimonials</h3>
                        <h3 className="text-4xl sm:text-6xl font-bold text-black text-opacity-50 lg:mr-48 my-4">Our Testimonials</h3>
                        <h3 className="text-4xl sm:text-6xl font-bold text-black text-opacity-25 lg:-mr-32 my-4">Our Testimonials</h3>
                    </div>
