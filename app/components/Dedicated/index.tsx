            ...
            <div className='mx-auto max-w-7xl px-4 my-40 sm:py-20 lg:px-8'>
                <div className='grid grid-cols-1 md:grid-cols-2 my-16'>
                    ...
                    <div className="relative">
                        ...
                        <h2 className="text-4xl lg:text-65xl pt-4 font-bold sm:leading-tight mt-5 text-center lg:text-start">Dedicated to Help Poeple As soon as Possible For Infection</h2>
                        ...
                        <p className="text-2xl font-semibold mt-12 lg:ml-32  text-center lg:text-start "> Healer Mulaikhan </p>
                    </div>
